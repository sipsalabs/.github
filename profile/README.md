...
Extreme compression infrastructure for large language models. The only sub-3-bits-per-weight method on a 6-model head-to-head benchmark with zero catastrophic failures.

```
pip install ultracompress
```

Apache-2.0 CLI. Pre-compressed reference models on the [Hugging Face Hub](https://huggingface.co/sipsalabs).
